...
A tiny Python script that models the prophet Teiresias's prophecy to Odysseus (Homer's *Odyssey*, Book 11) as what it actually is under the hood: a binary decision tree.
